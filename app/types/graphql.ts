...
export type UserFragmentFragment = { id: number; email: string; name: string; updatedAt: string; userRole: Role; createdAt: string };

export type ListUsersQueryVariables = Exact<{ [key: string]: never }>;

export type ListUsersQuery = { users: Array<{ id: number; email: string; name: string; updatedAt: string; userRole: Role; createdAt: string }> };
...
export function useListUsersQuery(options: VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables>> = {}) {
	return VueApolloComposable.useQuery<ListUsersQuery, ListUsersQueryVariables>(ListUsersDocument, {}, options);
}
export function useListUsersLazyQuery(options: VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ListUsersQuery, ListUsersQueryVariables>> = {}) {
	return VueApolloComposable.useLazyQuery<ListUsersQuery, ListUsersQueryVariables>(ListUsersDocument, {}, options);
}
